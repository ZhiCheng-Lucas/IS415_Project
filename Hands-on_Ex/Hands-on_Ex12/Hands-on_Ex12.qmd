---
title: "Hands-On Exercise 12 Geographically Weighted Predictive Models"
...
::: callout-note
Excluded **gwr predictive method**
:::
...
-   **Aspatial dataset**:
    ...
    -   HDB Resale data: a list of HDB resale transacted prices in Singapore from Jan 2017 onward. It is in csv format which can be downloaded from Data.gov.sg.

-   **Geospatial dataset**:

    -   *MP14_SUBZONE_WEB_PL*: a polygon feature data providing information of URA 2014 Master Plan Planning Sub zone boundary data. It is in ESRI shapefile format. This data set was also downloaded from Data.gov.sg
