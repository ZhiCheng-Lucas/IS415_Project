---
title: "Hands-On Exercise 10&11 Calibrating Hedonic Pricing Model for Private Highrise Property with GWR Method"
...
::: callout-note
This page contains hands on 10 & 11.
:::
...
It's because the data (MP14_SUBZONE_WEB_PL) is using SVY21 (Singapore's official projected coordinate system).

SVY21 uses metres as its unit of measurement.
:::
...
#### Computing the adaptive bandwidths
...
::: callout-note
Note that I will be setting the mode to plot for performance reasons.
:::
